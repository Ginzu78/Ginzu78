...
set tgqdb "/home/Bhuck/eggdrop/scripts/trivia.questions"
...
set tgscf "/home/Bhuck/eggdrop/scripts/trivia.scores"
...
set tgerrfil "/home/Bhuck/eggdrop/scripts/trivia.errors"

#  The e-mail address to send error reports to.
set tgerremail "suzogalkali@gmail.com"
...
set tghtmlfile "/home/personal/personal/BpSa/eggdrop/mychan.html"
...
proc tgerrremind {} {
   ...
   tggamemsg "[tgcolerr]Remember: to report errors in questions/answers, type /msg $botnick $tgcmderror <number> \[description\] or contact #Trivia-Quiz Admin"
   set tgerrremindtimer [timer $tgerrremindtime tgerrremind]
}
...
if {![info exists tghintnum]} {
   ...
   tggamemsg "[tgcolqhead]»» Trivia-Quiz Question «« [expr $tghintnum?"(Hint $tghintnum/$tgmaxhintcurrent)":""]"
...
proc tgjoinmsg {nick host hand chan} {
   ...
   if {$nick != $botnick} {
      ...
      append _msg " Please type \002/MSG $botnick [strupr $tgcmdhelp]\002 if you need help. #Trivia-Quiz Admin"
      [tgpriv] $nick "$_msg"
   }
}
