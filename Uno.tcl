...
proc UnoUnbindCmds {} {
 ...
 catch {unbind pub - a UnoPlayCard}
...
proc UnoNext {} {
 ...
 unochanmsg "$UnoVersion 4@ withyou.id"
...
proc UnoCmds {nick uhost hand chan txt} {
 ...
 unogntc $nick "$UnoLogo Commands: !uno !stop !remove \[nick\] !unowon \[nick\] !cmd !pause !join (joins the bot to the game)"
 unogntc $nick "$UnoLogo Stats: !rank \[games\|wins\|21\] !top3 !unostats !unorecords"
...
putlog "Loaded Color Uno $UnoVersion Copyright (C) 2022"
